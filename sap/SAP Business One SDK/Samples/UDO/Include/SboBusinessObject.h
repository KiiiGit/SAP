...
{
public:
	CSboBusinessObject (intptr_t lSystemHandle);
	...
	virtual SBOErr					OnYearTransfer (intptr_t companyRef);
...
public:
	...
	virtual SBOErr					OnCanArchive (const wchar_t* archivePeriod, const intptr_t lResRef);
