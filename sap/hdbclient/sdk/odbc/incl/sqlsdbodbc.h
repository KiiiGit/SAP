...
/*!
  @file           sqldbc_sdbodbc.h
  @author         TTK
  @ingroup        ODBC
  @brief          extra attributes (MaxDB specific)
  @see            
...
enum sql_sdb_aggregatetypes {
    SQL_AGGREGATETYPES_FLOAT = 0,   /* always float numbers (MaxDB default) */
    SQL_AGGREGATETYPES_ORIGIN };    /* data type matching to the orignial column (MS-SQL like) */
...
/* boolean parameter to tell the ODBC driver wether SQL catalogs are 
